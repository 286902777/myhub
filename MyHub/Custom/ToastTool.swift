...
public struct ToastStyle {
    ...
    */
    public var backgroundColor: UIColor = UIColor.rgbHex("#6F7980")
    
    /**
     The title color. Default is `UIColor.whiteColor()`.
    */
    public var titleColor: UIColor = UIColor.rgbHex("#FEFDF6")
    
    /**
     The message color. Default is `.white`.
    */
    public var messageColor: UIColor = UIColor.rgbHex("#FEFDF6")
    ...
    */
    public var horizontalPadding: CGFloat = 12.0
    ...
    */
    ...
    /**
     The image size. The default is 16 x 16.
    */
    ...
    */
     ...
     */
    public var activityIndicatorColor: UIColor = UIColor.rgbHex("#FEFDF6")
}
...
public enum ToastPosition {
    ...
    fileprivate func centerPoint(forToast toast: UIView, inSuperview superview: UIView) -> CGPoint {
        let topPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview.ESSafeAreaInsets.top
        let bottomPadding: CGFloat = ToastManager.shared.style.verticalPadding + superview.ESSafeAreaInsets.bottom
...
extension UIView {
    var ESSafeAreaInsets: UIEdgeInsets {
